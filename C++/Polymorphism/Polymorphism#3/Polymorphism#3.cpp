...
int main()
{
    ...
    cout << "The area of " << squares[2].getType() << " with a side of 7 is " << squares[2].getArea() << endl;

    // sum
    cout << "The sum of all areas is " << shapes[0].getArea() + shapes[1].getArea() + shapes[2].getArea() + squares[0].getArea() + squares[1].getArea() + squares[2].getArea() << endl;
