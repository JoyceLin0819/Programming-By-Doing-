// Graphic Boxy 1 50 points Joyce Lin 
import java.awt.*;
...
public class Boxy1 extends Canvas
{
	public void paint( Graphics window )
	{
		...
		window.fillRect(50,200,100,100);
        window.setColor(Color.WHITE);
		window.fillRect(60,210,80,80);

        window.setColor(Color.YELLOW);
		window.fillRect(400,350,100,100);
        window.setColor(Color.WHITE);
		window.fillRect(410,360,80,80);
	}
